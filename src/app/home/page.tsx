      ...
      <div className='container mx-auto p-6'>
        ...
        <div className='mb-12 grid grid-cols-1 gap-6 md:grid-cols-3'>
          <Card className='transition-shadow hover:shadow-lg'>
            ...
            <CardContent>
              <p className='mb-4 text-gray-600'>
                Browse and search through all registered athletes. View detailed
                profiles, personal information, and performance history.
              </p>
              <Link href='/athletes'>
          ...
          <Card className='transition-shadow hover:shadow-lg'>
            ...
            <CardContent>
              <p className='mb-4 text-gray-600'>
                Track individual and team performances across different events,
